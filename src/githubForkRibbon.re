...
let make = _children => {
  ...
  render: _self =>
    <div>
      <div className="github-fork-ribbon-wrapper right d-none d-xs-block d-sm-block"> ribbon </div>
      <div className="github-fork-ribbon-wrapper right-bottom d-block d-xs-none d-sm-none">
        ribbon
      </div>
    </div>
};
